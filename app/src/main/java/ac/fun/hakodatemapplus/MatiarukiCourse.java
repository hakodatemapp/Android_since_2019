...
/**
 * Created by g2115030 on 2015/12/02.
 */
public class MatiarukiCourse {
    // 選択したまちあるきコースに応じて表示内容を決定する
    private static List<LatLng> course_list;

    public static List<LatLng> getMatiarukiCourse(int course_id) {
