...
public class MainActivity extends FragmentActivity {
	...
	class SparqlGetThread extends Thread {
		...
		public void run() {
			...
			//観光スポットの取得
			setSparqlResult(spot_list, queue_url);
			...
			if (encoded_course != null) {
				...
				setSparqlResult(spot_list, queue_machi_url);
			}
		...
		public void setSparqlResult(ArrayList<ArrayList<String>> spot_list, String queue_url){
			try {
